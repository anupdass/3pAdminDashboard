...
const EditExpandRcve = () => {
    ...
    const validateForm = () => {
        ...
        if (!formData.receivedName.trim()) {
            alert('Please enter received name');
            return false;
        }
    ...
    const handleSubmit = async () => {
        ...
        try {
            const submissionData = {
                ...
                officeExpenditure: parseFloat(formData.officeExpenditure) || 0,
                uom: formData.uom.trim() || '',
                qty: parseFloat(formData.qty) || 0,
                paidAmount: parseFloat(formData.paidAmount) || 0,
                totalAmount: totalAmount,
                projectLocalExp: parseFloat(formData.projectLocalExp) || 0,
